...
var birdegisken = "18"; // var ile oluşturulan değişkenlerde değişkenin veri tepi c# tarafından değişkene atanan değere göre otmatik algılanır
var birsayi =18;
var strmetin = "var kullanılırsak değişkene değer atamak zorundayız!";
var sonuc = false;

Console.WriteLine(birdegisken);// ctrl+d ile çoğaltıyoruz
